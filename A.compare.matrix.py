...
def main():
    # ---------- 混淆矩阵（事件级） ----------
    mat1, acc1 = load_data("odata/v9.orignal.pnw.test.200.txt")
    mat2, acc2 = load_data("odata/v9.transfer.pnw.test.200.txt")
    ...
    gs = grid.GridSpec(1, 2, figure=fig, width_ratios=[1, 1], wspace=0.02)  # ← 缩小间距
